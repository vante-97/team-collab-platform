    ...
    <div className="page-bg flex items-center justify-center">
      <div className="w-full max-w-md mx-4 animate-scale-in">
        ...
        <form onSubmit={handleSubmit} className="glass-card p-8">
          ...
          <div className="mb-4">
            <label className="block text-white/50 text-sm mb-2">用户名</label>
            <input
              type="text"
              value={username}
          ...
          <div className="mb-4">
            <label className="block text-white/50 text-sm mb-2">邮箱</label>
            <input
              type="email"
              value={email}
          ...
          <div className="mb-6">
            <label className="block text-white/50 text-sm mb-2">确认密码</label>
            <input
              type="password"
